...
:uri-sonarcloud: https://sonarcloud.io/dashboard?id=com.codemonkeyfactory.test.logging
:img-reliability-rating: https://sonarcloud.io/api/project_badges/measure?project=com.codemonkeyfactory.test.logging&metric=reliability_rating
:img-security-rating: https://sonarcloud.io/api/project_badges/measure?project=com.codemonkeyfactory.test.logging&metric=security_rating
:img-coverage: https://sonarcloud.io/api/project_badges/measure?project=com.codemonkeyfactory.test.logging&metric=coverage
